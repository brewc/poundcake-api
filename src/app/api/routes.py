    ...
    for alert_data in webhook.alerts:
        try:
            ...
            if existing_alert:
                ...
                existing_alert.raw_data = alert_data.model_dump()
                ...
                alert = Alert(
                    ...
                    labels=alert_data.labels.model_dump(),
                    annotations=alert_data.annotations.model_dump() if alert_data.annotations else None,
                    starts_at=alert_data.startsAt,
                    ends_at=alert_data.endsAt,
                    generator_url=alert_data.generatorURL,
                    raw_data=alert_data.model_dump(),
