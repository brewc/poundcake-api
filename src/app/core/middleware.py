...
from app.models.models import APICall

logger = get_logger(__name__)


class RequestIDMiddleware(BaseHTTPMiddleware):
    """Middleware to add request ID to all requests and log non-GET calls to database."""
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        # For non-GET requests, log to database
        api_call = None
        if request.method != "GET":
            try:
                # Read request body (need to do this before call_next)
