...
def check_st2_database():
    """Check if StackStorm database exists."""
    print("\n📊 Checking StackStorm Database...")
    
    st2_db_url = os.getenv('ST2_DATABASE_URL', 'mysql+pymysql://stackstorm:stackstorm@localhost:3306/stackstorm')
    ...
    try:
        ...
        if found_tables:
            ...
            print(f"  ⚠ StackStorm tables not found")
            return False, []
...
def main():
    ...
    new_tables = create_poundcake_tables()
