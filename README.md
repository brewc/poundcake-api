...
A production-ready FastAPI application for processing Prometheus Alertmanager webhooks with Celery task queue, request ID tracking, and MariaDB storage.

## Features

- **FastAPI** - Modern, fast Python web framework
- **Celery** - Distributed task queue for async alert processing
- **MariaDB** - Reliable SQL database via SQLAlchemy
...
- **Database Logging** - All non-GET API calls stored in MariaDB
...
# Start MariaDB and Redis (via Docker)
